...
import drawVert from 'raw-loader!glslify-loader!../../assets/glsl/wind_gl/draw.vert.glsl';
import drawFrag from 'raw-loader!glslify-loader!../../assets/glsl/wind_gl/draw.frag.glsl';

import quadVert from 'raw-loader!glslify-loader!../../assets/glsl/wind_gl/quad.vert.glsl';

import screenFrag from 'raw-loader!glslify-loader!../../assets/glsl/wind_gl/screen.frag.glsl';
import updateFrag from 'raw-loader!glslify-loader!../../assets/glsl/wind_gl/update.frag.glsl';
...
export default class WindGL {
    ...
    setWind(windData, windImg) {
        const gl = this.gl;
        this.windData = windData;
        this.windTexture = util.createTexture(this.gl, this.gl.LINEAR, windImg, gl.canvas.width, gl.canvas.height);
    }
